...
_CUSTOM_CRACK_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 81331,  # num of samples in images/training
        'val': 27110,  # num of samples in images/validation
	'modeltest': 27111,  # num of samples in images/test
    },
    num_classes=2,
    ignore_label=255,
)
...
_DATASETS_INFORMATION = {
    ...
    'trainCustom': _CUSTOM_CRACK_INFORMATION,
}
