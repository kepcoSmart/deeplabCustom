...
flags.DEFINE_string('vis_logdir', './datasets/trainSet/visualization', 'Where to write the event logs.')
...
############# Custom dataset
flags.DEFINE_string('dataset', 'trainCustom',
...
flags.DEFINE_string('dataset_dir', './datasets/trainSet/tfrecord', 'Where the dataset reside.')
