...
from deeplab.datasets import data_generator_test
...
############# Custom save direction
flags.DEFINE_string('vis_logdir', './datasets/testSet/visualization', 'Where to write the event logs.')

############# Custom trained model direction
flags.DEFINE_string('checkpoint_dir', './datasets/trainSet/trainedmodel', 'Directory of model checkpoints.')
...
############# Custom image size
flags.DEFINE_list('vis_crop_size', '224,224',
...
############# Custom dataset
flags.DEFINE_string('dataset', 'testCustom',
                    'Name of the segmentation dataset.')

############# Custom test
flags.DEFINE_string('vis_split', 'modeltest',
                    'Which split of the dataset used for visualizing results')

############# Custom tfrecord direction
flags.DEFINE_string('dataset_dir', './datasets/testSet/tfrecord', 'Where the dataset reside.')

############# Custom colormap
flags.DEFINE_enum('colormap_type', 'ade20k', ['pascal', 'cityscapes', 'ade20k'],
...
def main(unused_argv):
  ...
  dataset = data_generator_test.Dataset(
  ...
  if dataset.dataset_name == data_generator_test.get_cityscapes_dataset_name():
